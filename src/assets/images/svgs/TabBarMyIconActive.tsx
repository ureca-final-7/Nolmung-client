...
const SvgTabBarMyIconActive = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#080808"
      d="M14.307 9.292c0 1.496-1.261 2.708-2.816 2.708-1.556 0-2.817-1.212-2.817-2.708s1.261-2.708 2.817-2.708c1.555 0 2.816 1.212 2.816 2.708"
    />
    <path
      stroke="#fff"
      strokeLinecap="round"
...
export default SvgTabBarMyIconActive;
